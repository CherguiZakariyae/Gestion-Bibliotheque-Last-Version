                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-0 header-title">Ajouter Adherent</h4><br>
                                        ...
                                        <div class="form-group row col-sm-6" style="display: inline-block;margin-top: -10px;">
                                            <label for="example-search-input" class="col-sm-5 col-form-label">Prenom</label>
                                            <div class="col-sm-12">
                                          ...
                                          <div class="form-group row col-sm-6" style="display: inline-block;margin-top: -10px;">
                                            <label for="example-search-input" class="col-sm-5 col-form-label">Adresse</label>
                                            <div class="col-sm-12">
                                                <input class="form-control" type="search" value="" id="example-search-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row col-sm-6" style="display: inline-block;margin-top: -10px;">
                                            <label for="example-search-input" class="col-sm-5 col-form-label">Telephone</label>
                                            <div class="col-sm-12">
                                                <input class="form-control" type="search" value="" id="example-search-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row col-sm-6" style="display: inline-block;margin-top: -10px;">
                                            <label for="example-search-input" class="col-sm-5 col-form-label">CIN</label>
                                            <div class="col-sm-12">
                                                <input class="form-control" type="search" value="" id="example-search-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row col-sm-6" style="display: inline-block;margin-top: -10px;">
                                            <label for="example-search-input" class="col-sm-5 col-form-label">Matricle</label>
                                            <div class="col-sm-12">
                                                <input class="form-control" type="search" value="" id="example-search-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row col-sm-6" style="display: inline-block;margin-top: -10px;">
                                            <label for="example-search-input" class="col-sm-5 col-form-label"> Image</label>
                                            <div class="col-sm-12">
                                                <input class="form-control" type="search" value="" id="example-search-input">
                                            </div>
                                        </div>
